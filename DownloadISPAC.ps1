...
$SsisServer = "Specify SSIS server" # Mandatory
$FolderName = "Specify SSISDB FOlder"         # Can be empty to download multiple projects
$ProjectName = "Specify Project"       # Can be empty to download multiple projects
